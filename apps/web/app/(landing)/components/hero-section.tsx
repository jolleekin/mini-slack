      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center lg:text-left">
          ...
          <div className="flex flex-col items-center lg:items-start gap-7">
            ...
            >
              <span className="text-gray-12">Team messaging</span>
              <br />
              {/* Gradient accent line */}
              <span className="bg-clip-text text-transparent bg-linear-135 from-accent-11 via-accent-9 to-accent-8">
                without the noise
              </span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-11 max-w-xl leading-relaxed">
              A fast, focused messaging app for small teams. Real-time channels,
              workspaces, and file sharing — built to keep your team in sync.
            </p>
