...
ALTER TABLE "channel_members" ADD CONSTRAINT "channel_members_workspace_id_channel_id_fk" FOREIGN KEY ("workspace_id","channel_id") REFERENCES "public"."channels"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_workspace_id_channel_id_fk" FOREIGN KEY ("workspace_id","channel_id") REFERENCES "public"."channels"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reactions" ADD CONSTRAINT "reactions_workspace_id_channel_id_message_id_fk" FOREIGN KEY ("workspace_id","channel_id","message_id") REFERENCES "public"."messages"("workspace_id","channel_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "message_files" ADD CONSTRAINT "message_files_workspace_id_file_id_fk" FOREIGN KEY ("workspace_id","file_id") REFERENCES "public"."files"("workspace_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "message_files" ADD CONSTRAINT "message_files_workspace_id_channel_id_message_id_fk" FOREIGN KEY ("workspace_id","channel_id","message_id") REFERENCES "public"."messages"("workspace_id","channel_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
